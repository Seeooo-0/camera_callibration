...
input_file = './chessboard_video.mp4'
K = np.array([[2.94749334e+03, 0, 6.10563947e+02],
              [0, 2.94478350e+03, 3.25682941e+02],
              [0, 0, 1]])
dist_coeff = np.array([-1.18716673e+00,  5.11612278e+01,  8.58489735e-03,  1.19015586e-03, -8.64504808e+02])
board_pattern = (8, 6)
